...
The exact Africa map screenshot supplied by the game designer is included unchanged as:
`assets/africa-reference.jpg`

It is displayed as a real `<img>` on the left side of the gameplay screen. No recreated or generated map is used for this reference image.
